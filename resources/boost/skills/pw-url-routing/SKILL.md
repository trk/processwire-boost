...
> [!IMPORTANT]
> **CRITICAL DOCUMENTATION RULE**: Before writing any ProcessWire code or using its API, you MUST consult the local API documentation located at `.llms/docs/index.md`. You MUST NOT hallucinate API methods. 
